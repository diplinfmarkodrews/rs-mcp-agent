...
namespace MCPServer.Infrastructure.Java;
...
public static class JniHelper
{
    ...
    /// </summary>
    public static List<ReportTemplate> ConvertJavaReportTemplateListToCSharp(IntPtr env, IntPtr javaList)
    {
    ...
    /// </summary>
    private static ReportTemplate ConvertJavaReportTemplateToCSharp(IntPtr env, IntPtr javaTemplate)
    {
    ...
    /// </summary>
    private static List<ParameterDefinition> ConvertJavaParameterDefinitionListToCSharp(IntPtr env, IntPtr javaList)
    {
    ...
    /// </summary>
    private static ParameterDefinition ConvertJavaParameterDefinitionToCSharp(IntPtr env, IntPtr javaParameter)
    {
        ...
        if (typeJni != IntPtr.Zero) parameter.Type = GetStringFromJniString(env, typeJni) ?? string.Empty;
