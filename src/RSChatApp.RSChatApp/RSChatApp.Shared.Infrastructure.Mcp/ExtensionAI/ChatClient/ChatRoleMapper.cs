...
{
    internal static MsAI.ChatRole ToExtensionsAI(ChatRole role) => role.Name switch
    {
    ...
    internal static AuthorRole ToSemanticKernel(this ChatRole role) => role.Name switch
    {
