...
public sealed class FilePromptStore : IPromptStore, IDisposable
{
    ...
    private readonly ILogger<FilePromptStore> _logger;
    ...
    public FilePromptStore(IWebHostEnvironment environment, ILogger<FilePromptStore> logger)
    {
        _logger = logger;
