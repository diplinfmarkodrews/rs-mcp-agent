...
import net.datenwerke.rs.sidecar.service.ReportServerGwtRpcService;
...
public class ReportServerController {
    ...
    private final ReportServerGwtRpcService gwtRpcService;
    
    public ReportServerController(ReportServerGwtRpcService gwtRpcService) {
        this.gwtRpcService = gwtRpcService;
    }
    ...
    public ResponseEntity<AuthenticationResponse> login(@RequestBody AuthenticationRequest request) {
        ...
        try {
            AuthenticationResponse response = gwtRpcService.authenticate(request);
    ...
    public ResponseEntity<AuthenticationResponse> checkAuthentication(
        ...
        try {
            AuthenticationResponse response = gwtRpcService.checkAuthentication(effectiveSessionId);
    ...
    public ResponseEntity<String> logout(
        ...
        try {
            gwtRpcService.logout(effectiveSessionId);
    ...
    public ResponseEntity<SecurityViewInformation> getSecurityViewInformation(
        ...
        try {
            SecurityViewInformation info = gwtRpcService.loadSecurityViewInformation(nodeId, effectiveSessionId);
